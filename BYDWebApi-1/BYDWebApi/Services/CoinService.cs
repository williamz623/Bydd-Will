...
namespace BYDWebApi.Services
{
  public class CoinService
  {
    ...
    {
      // Instead of querying the database, return a list of generic coins
      return new List<Coin>
        {
            new Coin
            {
                CoinId = 1,
                Name = "Generic Coin A",
                Description = "Description for Generic Coin A.",
                ImageUrls = new[] { "https://example.com/generic-coin-a.jpg" }
            ...
            new Coin
            {
                CoinId = 2,
                Name = "Generic Coin B",
                Description = "Description for Generic Coin B.",
                ImageUrls = new[] { "https://example.com/generic-coin-b.jpg" }
                // Add more properties as needed
            }
            // Add more generic coins as needed
        };
    }
    //public List<Coin> GetCoinsInHomePage()
    //{
    ...
    public List<CategoryCoin> GetCategoryCoins()
    {
      ...
      List<CategoryCoin> coins = new List<CategoryCoin>();
      return coins;
    }
    ...
    public List<CoinImage> getCoinOriginalImageById(int coinId)
    {
      using (IDbConnection _db = new SqlConnection(_ConnectString))
      {
        ...
        //placeholder image:
        List<CoinImage> coinImages = new List<CoinImage>();
        coinImages.Add(new CoinImage() { Image1 = "https://www.usmint.gov/wordpress/wp-content/uploads/2022/12/2023-lincoln-penny-uncirculated-obverse-philadelphia.jpg" });
        return coinImages;
      }
    }
    ...
    public List<CoinWatchlist> getMyWatchList(int userId)
    {
      ...
      using (IDbConnection _db = new SqlConnection(_ConnectString))
      {
        ...
        //Place holder image:
        List<string> imageContents = new List<string>();
        imageContents.Add("https://www.usmint.gov/wordpress/wp-content/uploads/2022/12/2023-lincoln-penny-uncirculated-obverse-philadelphia.jpg");
        imageContents.Add("https://www.usmint.gov/wordpress/wp-content/uploads/2022/12/2023-lincoln-penny-uncirculated-obverse-philadelphia.jpg");
        imageContents.Add("https://www.usmint.gov/wordpress/wp-content/uploads/2022/12/2023-lincoln-penny-uncirculated-obverse-philadelphia.jpg");
        imageContents.Add("https://www.usmint.gov/wordpress/wp-content/uploads/2022/12/2023-lincoln-penny-uncirculated-obverse-philadelphia.jpg");
        imageContents.Add("https://www.usmint.gov/wordpress/wp-content/uploads/2022/12/2023-lincoln-penny-uncirculated-obverse-philadelphia.jpg");
        List<CoinWatchlist> coins = new List<CoinWatchlist>();
        coin.ImageUrls = imageContents.ToArray();
        CoinWatchlist watchlist = new CoinWatchlist();
        coins.Add(watchlist);
        return coins;
      }
    }
